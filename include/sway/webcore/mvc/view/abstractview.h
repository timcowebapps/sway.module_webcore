#ifndef _SWAY_WEBCORE_MVC_VIEW_ABSTRACTVIEW_H
#define _SWAY_WEBCORE_MVC_VIEW_ABSTRACTVIEW_H
...
#include <sway/webcore/mvc/view/abstractview.inl>

#endif // _SWAY_WEBCORE_MVC_VIEW_ABSTRACTVIEW_H
